...
public class DropTableConfig {
	...
	private static DropTableConfig uniqueInstance;
	 ...
	 */
	protected DropTableConfig(String inputFile) {
	...
	static public DropTableConfig getInstance(String inputFile) {
		log.info("--------reading configuration file---------");
		if (uniqueInstance == null) {
			//System.out.println("null");
			uniqueInstance = new DropTableConfig(inputFile);
		}
